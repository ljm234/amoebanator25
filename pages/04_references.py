...
st.markdown(
    """
- **`guo2017calibration`** Guo C, Pleiss G, Sun Y, Weinberger KQ. *On Calibration of Modern Neural Networks.* **ICML** 2017. The demo applies temperature scaling per this paper; T=0.27 amplification is disclosed on the Predict page badge + About-page section 3.
